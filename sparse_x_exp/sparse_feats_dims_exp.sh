...
do
    ...
    do
        ...
        do
            ...
            echo ${val}
            nsys profile -t cuda,osrt,nvtx -f true --export=sqlite -o "${dir_config}/config0_${model}_${data}_${var}_20" -w true python ../main.py --dataset "${data}_${var}_20" --model ${model} --x_sparse
        done
    done
done
