...
dir_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "batch_acc_cum")
...
for i, mode in enumerate(['cluster', 'graphsage']):
    ...
    for alg in algs:
        for data in small_datasets:
            ...
            if mode == 'cluster':
                cmd = "python -u /home/wangzhaokang/wangyunpan/gnns-project/pyg-gnns/main_sampling_batch_acc_cum.py --epochs 10000 --mode {} --model {} --data {} --device cuda:{} --batch_partitions {} {} >>{} 2>&1"
                ...
                cmd = "python -u /home/wangzhaokang/wangyunpan/gnns-project/pyg-gnns/main_sampling_batch_acc_cum.py --epochs 10000 --mode {} --model {} --data {} --device cuda:{} --batch_size {} {} >>{} 2>&1"
    ...
    with open("batch_acc_cum_" + mode + ".sh", "w") as f:
