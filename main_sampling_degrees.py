...
def train(epoch):
    ...
    while True:
        try:
            ...
            if args.mode == "cluster":
                if cnt == 5:
                    np.save("paper_exp4_relative_sampling/batch_degrees_distribution/amp_cluster_90.npy", batch.edge_index.numpy()) 
                ...
                if cnt == 5:
                    np.save("paper_exp4_relative_sampling/batch_degrees_distribution/amp_graphsage_459.npy", adjs[0][0].numpy())
