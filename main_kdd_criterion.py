...
parser.add_argument('--epochs', type=int, default=100000, help="epochs for training: KDDCriterion default")
parser.add_argument('--patience_step', type=int, default=50, help="KDDCriterion default")
