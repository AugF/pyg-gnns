...
From the efficiency aspect, Yan et al. \cite{yan2020_characterizing_gcn} compare the performance characteristics of graph convolutional networks, typical graph processing kernels(like PageRank), and the MLP-based neural networks on GPU.
They provide optimization guidelines for both the software and the hardware developers.
Zhang et al. \cite{zhang2020_analysis_neugraph} analyze the architectural characteristics of the GNN inference on GPU under SAGA-NN \cite{ma2019_neugraph} model.
