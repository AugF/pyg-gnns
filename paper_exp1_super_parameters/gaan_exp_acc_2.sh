...
do
    ...
    do
        ...
        do
            ...
            python ../main.py --device cuda:1 --runs 2 --dataset ${data} --model ${model} --hidden_dims ${hd} --heads 4 --d_v 32 --d_a 32 --d_m 32 1>"${dir_config}/config0_${model}_${data}_4_32_${hd}.log" 2>&1
        done
