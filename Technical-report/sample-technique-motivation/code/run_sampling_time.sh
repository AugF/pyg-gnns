...
do
    ...
    date
    python -u cluster_gcn.py --batch_size ${batch_size} 1>>"cluster_gcn_${batch_size}".log 2>&1
    date
done
...
do
    echo "batch_size=${batch_size}"
    date
    python -u graph_saint.py --batch_size ${batch_size} 1>>"graph_saint_${batch_size}".log 2>&1
    date
done
...
do
    echo "batch_size=${batch_size}"
    date
    python -u neighbor_sampling.py --batch_size ${batch_size} 1>>"neighbor_sampling_${batch_size}".log 2>&1
    date
done
