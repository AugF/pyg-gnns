...
\begin{reply}
    ...
    In the revised manuscript, $\boldsymbol{e}_{i,j}$ represents the input feature vector of the edge $e_{i,j}$.
    %
    ...
    %
    $\boldsymbol{s}^l_i$ represents the aggregated vector of the graph neuron corresponding to the vertex $v_i$ in the GNN layer $l$.
    %
    If the GNN layer $l$ has sub-layers, $\boldsymbol{s}^{l,k}_i$ represents the aggregated vector corresponding to $v_i$ in the $k$-th sub-layer.
