...
\begin{reply}
    ...
    %
    We have proofread our revised manuscript to eliminate grammar errors and typos as much as we can.
    %
...
%    The \texttt{scatter\_add} operator was related to the edge calculation step.
    ...
    \paragraph{Section 4.3 ``Memory Usage Analysis''}
     ...
     \begin{figure}[H]
%        \subfloat[Training]{\includegraphics[width=0.5\columnwidth]{imagefile}}
     \end{figure}
