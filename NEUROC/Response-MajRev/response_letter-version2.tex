...
%
We also presented the memory usage analysis of GNN inference in Section 4.3.2., and the performance bottlenecks of sample-based inference were analyzed in Section 4.4.2.
...
%
Finally, we analyzed the effects of the sampling techniques on accuracy in Section 4.4.3.
