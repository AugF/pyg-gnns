...
\begin{reply}
    ...
    \begin{figure}[h]
        \centering
        \subfloat[\texttt{amc}]{\includegraphics[width=0.33\columnwidth]{../figs/experiments/exp_time_comparison_between_training_inference_amazon-computers.pdf}}
        \subfloat[\texttt{amp}]{\includegraphics[width=0.33\columnwidth]{../figs/experiments/exp_time_comparison_between_training_inference_amazon-photo.pdf}}
        \subfloat[\texttt{fli}]{\includegraphics[width=0.33\columnwidth]{../figs/experiments/exp_time_comparison_between_training_inference_flickr.pdf}}
...
\begin{reply}
    ...
    %
    As the dimensions increase to a certain threshold, GaAN gains sufficient representation capability to achieve good accuracy.
    %
