...
\begin{figure}[H]
    \centering
    \subfloat[\emph{layer} level]{\includegraphics[width=0.3\columnwidth]{figs/experiments/exp_inference_full_avg_degree_on_vertex_edge_cal_time_gcn.pdf}}
    \subfloat[the effect of average degree]{\includegraphics[width=0.3\columnwidth]{figs/experiments/exp_inference_full_avg_degree_on_vertex_edge_cal_time_gcn.pdf}}
    \subfloat[\emph{edge} level]{\includegraphics[width=0.3\columnwidth]{figs/experiments/exp_inference_full_edge_calc_decomposition_gcn.pdf}}
    \caption{Time breakdowns on the layer level and edge level, and the effect of average degree on the edge/vertex calculation of GCN Inference.}
