...
\begin{itemize}
    \item \figurename~\ref{fig:exp_inference_full_memory_usage_stage_amp} shows the peak memory usage of each phase during inference stage.
    \figurename~\ref{fig:exp_inference_full_memory_expansion_ratio} compares MER of different GNNs on inference stage. We found that 
    \item
\end{itemize}
