...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_pubmed.pdf}
    \includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_amazon-photo.pdf}
    \includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_coauthor-physics.pdf}

    \includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_amazon-computers.pdf}
    \includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_flickr.pdf}
    \includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_com-amazon.pdf}
    %\subfloat[\label{fig:exp_absolute_training_time_pubmed}]{\includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_pubmed.pdf}}
    %\subfloat[\label{fig:exp_absolute_training_time_amazon-photo}]{\includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_amazon-photo.pdf}}
    %\subfloat[\label{fig:exp_absolute_training_time_coauthor-physics}]{\includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_coauthor-physics.pdf}} \\
    %\subfloat[\label{fig:exp_absolute_training_time_amazon-computers}]{\includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_amazon-computers.pdf}}
    %\subfloat[\label{fig:exp_absolute_training_time_flickr}]{\includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_flickr.pdf}}
    %\subfloat[\label{fig:exp_absolute_training_time_com-amazon}]{\includegraphics[width=0.32\textwidth]{figs/experiments/exp_absolute_training_time_comparison_com-amazon.pdf}}
...
To further evaluate effects of hyper-parameters on performance, we measured the training time of each GNN with varying hyper-parameters in \figurename~\ref{fig:exp_hyperparameter_on_vertex_edge_phase_time_gcn} to \figurename~\ref{fig:exp_hyperparameter_on_vertex_edge_phase_time_gaan}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/experiments/exp_hyperparameter_on_vertex_edge_phase_time_gcn.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/experiments/exp_hyperparameter_on_vertex_edge_phase_time_ggnn.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/experiments/exp_hyperparameter_on_vertex_edge_phase_time_gat.pdf}
...
\begin{figure}[H]
    ...
    \subfloat[GAT]{\includegraphics[width=0.5\columnwidth]{figs/experiments/exp_hyperparameter_on_memory_usage_gat.pdf}}\\
...
In the implementation in PyG, the GNN model resided on the GPU side and the dataset resided on the host side.
%
...
%
To train the GNN model with each batch, PyG sent the sampled subgraph to the GPU, calculated the gradients on the subgraph, and updated the model parameters directly on the GPU.
%
