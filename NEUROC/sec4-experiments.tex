...
\begin{figure}[H]
    ...
    \caption{Memory usage of each phase during the GNN inference. Dataset: \texttt{amp}.}
...
\begin{figure}[H]
    ...
    \caption{Memory expansion ratio under different dimensions of input feature vectors during inference. Dataset: \texttt{cam}.}
