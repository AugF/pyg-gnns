...
In the implementation in PyG, the model parameters of GNNs resid on the GPU side and the input graph resides on the host side.
%
...
%
When a graph update arrives, the subgraph affected by the update is sampled and inferences are only performed on the sampled subgraph.
