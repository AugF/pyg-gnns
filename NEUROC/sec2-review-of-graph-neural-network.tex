...
\begin{table}[h]
    ...
    \begin{tabular}{p{3em}lp{35em}}
       ...
       Category & Symbol & Meaning \\
        ...
        & $d^l_{in}$, $d^l_{out}$ &  The dimensions of the input/output hidden vectors of the GNN layer $l$. \\
...
The two sub-layers also follow the message-passing model.
...
For every sampled vertex $v_x$ in the GNN layer $l$, GraphSAGE samples at most $S^l$ neighbors of $v_x$ from the previous GNN layer.
