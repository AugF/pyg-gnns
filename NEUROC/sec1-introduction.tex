...
\begin{itemize}
    \item \textbf{The training/inference time and the memory usage of a GNN layer is mainly affected by the dimensions of the input/output hidden feature vectors.}
    ...
    For GNNs with high edge calculation complexity, most of the training/inference time is spent on conducting the messaging function for every edge. 
    ...
    As GPUs have limited on-chip memory, the high memory consumption prevents us from training/inferring big graphs on GNNs.
