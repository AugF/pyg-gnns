...
\begin{frontmatter}
	...
	\begin{abstract}
		...
		In this work, we analyze the performance bottleneck in GNN training and inference with GPUs empirically. 
		...
		Future optimization can focus on it. The sampling techniques are essential for GNN training and inference on big graphs with GPUs, but their current implementations still have room for improvement.
	\end{abstract}
