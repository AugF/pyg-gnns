...
do
    ...
    do
        ...
        do
            ...
            nsys profile -t cuda,osrt,nvtx -o "${dir_config}/config0_${model}_${data}_4_${hd}" -w true python ../main.py --layers 3 --dataset ${data} --model ${model} --head_dims ${hd} --d_v ${hd} --d_a ${hd} --heads 4
        ...
        do
            ...
            nsys profile -t cuda,osrt,nvtx -o "${dir_config}/config0_${model}_${data}_${h}_32" -w true python ../main.py --layers 3 --dataset ${data} --model ${model} --head_dims 32 --d_v 32 --d_a 32 --heads ${h}
