...
\begin{itemize}
      \item To reduce training time, optimizations should focus on improving the efficiency of the edge calculation. 
      ...
      \item To reduce memory usage, optimizations should focus on reducing the intermediate results in the edge calculation. 
      ...
      \item To improve the efficiency of the sampling techniques, one may consider overlapping the sampling on the CPU side with the training on the GPU side. 
