...
\begin{figure}
    \centering
    \subfloat[GCN]{\includegraphics[height=4cm]{figs/experiments/exp_vertex_edge_cal_proportion_gcn.pdf}}
    \subfloat[GGNN]{\includegraphics[height=4cm]{figs/experiments/exp_vertex_edge_cal_proportion_ggnn.pdf}}\\
    \subfloat[GAT]{\includegraphics[height=4cm]{figs/experiments/exp_vertex_edge_cal_proportion_gat.pdf}}
    \subfloat[GaAN]{\includegraphics[height=4cm]{figs/experiments/exp_vertex_edge_cal_proportion_gaan.pdf}}
