...
\begin{figure}
    \centering
    \includegraphics[height=4cm]{figs/experiments/exp_small_graph_train_time.pdf}
    \caption{Training time on small random graphs. Graphs were generated with the R-MAT generator with the average degree as X.}
...
As the number of vertices increased, the training time was nearly unchanged except for GaAN.
The training time of GaAN only became larger then $|\mathcal{V}| \geq 8000$.
