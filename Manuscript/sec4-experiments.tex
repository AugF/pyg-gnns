...
\begin{figure}
    ...
    \subfloat[GAT\label{fig:exp_hyperparameter_on_vertex_edge_phase_time_gat}]{\includegraphics[height=4cm]{figs/experiments/exp_hyperparameter_on_vertex_edge_phase_time_gat.png}}\\
    \subfloat[GaAN\label{fig:exp_hyperparameter_on_vertex_edge_phase_time_gaan}]{\includegraphics[height=4cm]{figs/experiments/exp_hyperparameter_on_vertex_edge_phase_time_gaan.png}}
    \caption{The influence of hyperparameters on GNN vertex/edge calculation time}
...
\begin{figure}
    ...
    \caption{The effect of hyperparameters on GPU memory usage during the training phase (excluding the dataset itself)}
...
Because the input feature dimension of the cph dataset is much higher than the hidden vector of the GNN layer The dimension of the input feature vector matrix
...
The average degree of the amp dataset is 31.1, but the average degree of the sampled subgraphs is only 5.8,
which is much lower than the average degree of the full picture;
the average degree of the subgraphs sampled by the cluster sampler is lower, only 3.0.
Fig~\ref{fig:exp_sampling_minibatch_degrees_distribution) shows the comparison of the distribution of the sampled sub-graphs with the original image.
...
so that the average degree drops significantly. Combined with the experimental results in section 4.2 The decrease in the average degree of sampling subgraphs will increase the time-consuming
