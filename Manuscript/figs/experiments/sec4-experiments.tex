...
The reason is that the distribution of vertices in the actual graph data set follows a power-rate distribution, and a small number of vertices The degree is very high,
...
proportion of point calculation. For GGNN with high point calculation complexity, point calculation will replace edge calculation and become a performance bottleneck.
